...
M.set = function()
    set_terminal_color()
    hl('Normal', { fg = colors.dark_6, bg = colors.light_1_b })
    ...
    hl('DiffAdd', { fg = colors.teal_3, bg = colors.light_2_b })
    hl('DiffChange', { fg = colors.orange_3, bg = colors.light_2_b })
    hl('DiffDelete', { fg = colors.red_1, bg = colors.light_2_b })
    hl('DiffText', { fg = colors.orange_4, bg = colors.light_2_b })
    hl('EndOfBuffer', { fg = colors.light_2_b })
    hl('ErrorMsg', { fg = colors.red_3, underline = true })
    hl('VertSplit', { fg = colors.light_2 })
    ...
    hl('LineNr', { fg = colors.dark_3 })
    hl('CursorLineNr', { fg = colors.light_4, bg = colors.light_3, bold = true })
    ...
    hl('TabLine', { fg = colors.dark_3, bg = colors.light_2_b })
    hl('TabLineFill', { fg = colors.dark_3, bg = colors.light_4 })
    hl('TablineSel', { fg = colors.dark_5, bg = colors.light_2_b })
    hl('Title', { bold = true })
